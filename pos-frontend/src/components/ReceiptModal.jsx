...
export default function ReceiptModal({ isOpen, onClose, transaction }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm print:p-0 print:bg-white print:block print:relative">
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 relative print:shadow-none print:w-full print:max-w-none print:rounded-none">
            ...
            <style>{`
                @media print {
                    ...
                    .fixed { position: absolute; margin: 0; padding: 0; background: white; inset: 0; }
